...
- Provisional transport acceptance, dormant execution path, Dispatcher migration, production-установка Runtime-cancellation observation, production-активация terminal chain, shutdown orchestration и интеграция с Runtime Host в Go-коде отсутствуют.
