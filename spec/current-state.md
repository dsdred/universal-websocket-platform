...
- Provisional transport acceptance, dormant execution path, Dispatcher migration, Runtime-cancellation callback lifecycle, callback drain, Terminal Result, Terminal Observer, полный terminal chain, lease release из Owner, shutdown orchestration и интеграция с Runtime Host в Go-коде отсутствуют.
