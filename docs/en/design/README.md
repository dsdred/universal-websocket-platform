...
| [DP-015: Runtime Management Command Idempotency](DP-015-runtime-management-command-idempotency.md) | Approved; Partial implementation: TASK-062 implements the bounded parent-terminalization repair in isolation and is pending independent review |
| [DP-016: Runtime Activation, Replacement, and Rollback](DP-016-runtime-activation-replacement-rollback.md) | Approved; planned; TASK-061 historical accepted `READY — UNBLOCK` remains 7/10/2/0/0/0; TASK-026 remains Blocked and is not reactivated by TASK-062 |
...
| [DP-019: Runtime Activation Orchestration Prerequisites](DP-019-runtime-activation-orchestration-prerequisites.md) | Approved; planned overall; TASK-062 implements the separate DP-015 parent-terminalization prerequisite in isolation and is pending independent review; TASK-026 remains Blocked |
| [DP-020: Runtime Orchestration Binding Sequence Readiness](DP-020-runtime-orchestration-binding-sequence-readiness.md) | Draft; planned overall; TASK-061 historical readiness is preserved; TASK-062 is the isolated repair task, and TASK-026 remains Blocked |
| [DP-021: Private Exact-Scope Managed Start Invoker](DP-021-private-exact-scope-managed-start-invoker.md) | Draft; partial, implemented in isolation by TASK-043; invoker boundary is unchanged; TASK-062 repair is outside DP-021 and does not reactivate TASK-026 |
