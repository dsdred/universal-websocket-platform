...
| [DP-022: Runtime Execution Containment and Evidence](DP-022-runtime-execution-containment-and-evidence.md) | Draft; planned; defines the containment/evidence prerequisite required by DP-017 section 11; no containment capability, ledger, or evidence adapter exists, and DP-017 implementation stays unactivated |
