...
| [DP-015: Runtime Management Command Idempotency](DP-015-runtime-management-command-idempotency.md) | Approved; primitive/parent managed gates, parent/phase core, Continue/pending-Stop, Slice 3 continuation, and TASK-047 tracked-Start managed-parent admission implemented in isolation; TASK-049 replay-first/late-generation design refinement completed and Coordinator Accepted; isolated implementation Not Activated |
| [DP-016: Runtime Activation, Replacement, and Rollback](DP-016-runtime-activation-replacement-rollback.md) | Approved; planned; TASK-026 Blocked; TASK-049 design refinement completed and Coordinator Accepted; isolated implementation Not Activated with no Task ID |
