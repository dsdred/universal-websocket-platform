...
| [DP-015: Runtime Management Command Idempotency](DP-015-runtime-management-command-idempotency.md) | Approved; Partial implementation: TASK-062 parent-terminalization repair accepted/published; TASK-064 durable primitive Satisfied-outcome repair Coordinator Accepted in isolation, not committed or published |
| [DP-016: Runtime Activation, Replacement, and Rollback](DP-016-runtime-activation-replacement-rollback.md) | Approved; planned; TASK-026 remains Blocked after isolated Coordinator Accepted TASK-064 prerequisite; no current TASK-026 implementation exists |
...
| [DP-019: Runtime Activation Orchestration Prerequisites](DP-019-runtime-activation-orchestration-prerequisites.md) | Approved; planned overall; accepted/published TASK-062 satisfies the parent-terminalization prerequisite; TASK-064 durable Satisfied-outcome prerequisite is Coordinator Accepted in isolation; TASK-026 remains Blocked |
| [DP-020: Runtime Orchestration Binding Sequence Readiness](DP-020-runtime-orchestration-binding-sequence-readiness.md) | Draft; planned overall; TASK-061 historical readiness is preserved; TASK-062 is accepted/published and TASK-063 restored 7/10/2/0/0/0 readiness; TASK-064's later DP-015 repair is Coordinator Accepted in isolation and TASK-026 remains Blocked |
| [DP-021: Private Exact-Scope Managed Start Invoker](DP-021-private-exact-scope-managed-start-invoker.md) | Draft; partial, implemented in isolation by TASK-043; invoker boundary is unchanged; accepted/published TASK-062 and active TASK-064 repairs are outside DP-021; TASK-026 remains Blocked |
