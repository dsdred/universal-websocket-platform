...
| [DP-015: Runtime Management Command Idempotency](DP-015-runtime-management-command-idempotency.md) | Approved; Partial implementation: primitive/parent managed gates, parent/phase core, Continue/pending-Stop, Slice 3 continuation, TASK-047 tracked-Start managed-parent admission, and TASK-057 replay-first/late-generation admission implemented and prospectively accepted in isolation |
| [DP-016: Runtime Activation, Replacement, and Rollback](DP-016-runtime-activation-replacement-rollback.md) | Approved; planned; TASK-061 `READY — UNBLOCK` with 7/10/2/0/0/0; TASK-026 Ready to Reactivate but Not Activated |
...
| [DP-019: Runtime Activation Orchestration Prerequisites](DP-019-runtime-activation-orchestration-prerequisites.md) | Approved; planned overall; managed command/Flow/continuation and attempt/generation binding seams plus TASK-057 replay-first/late-generation admission implemented in isolation; TASK-061 `READY — UNBLOCK`; TASK-026 Not Activated |
| [DP-020: Runtime Orchestration Binding Sequence Readiness](DP-020-runtime-orchestration-binding-sequence-readiness.md) | Draft; planned overall; Slice 3 and TASK-057 replay-first/late-generation slice implemented in isolation; TASK-060 prospectively accepts four exact claims; TASK-026 Not Activated |
| [DP-021: Private Exact-Scope Managed Start Invoker](DP-021-private-exact-scope-managed-start-invoker.md) | Draft; partial, implemented in isolation by TASK-043; TASK-057 command-boundary prerequisite prospectively accepted through TASK-060; callback/terminal/orchestrator integration remains absent |
