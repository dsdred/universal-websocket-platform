...
| [DP-015: Runtime Management Command Idempotency](DP-015-runtime-management-command-idempotency.md) | Approved; Partial implementation: primitive/parent managed gates, parent/phase core, Continue/pending-Stop, Slice 3 continuation, TASK-047 tracked-Start managed-parent admission, and TASK-057 replay-first/late-generation admission implemented in isolation; TASK-057 projected In Progress under post-sync verification |
| [DP-016: Runtime Activation, Replacement, and Rollback](DP-016-runtime-activation-replacement-rollback.md) | Approved; planned; TASK-026 Blocked; TASK-049 design refinement completed and Coordinator Accepted; TASK-057 isolated prerequisite implemented under verification, pending separate post-acceptance readiness reassessment |
...
| [DP-019: Runtime Activation Orchestration Prerequisites](DP-019-runtime-activation-orchestration-prerequisites.md) | Approved; planned overall; managed command/Flow/continuation and attempt/generation binding seams plus TASK-057 replay-first/late-generation admission implemented in isolation; TASK-026 remains Blocked |
| [DP-020: Runtime Orchestration Binding Sequence Readiness](DP-020-runtime-orchestration-binding-sequence-readiness.md) | Draft; planned overall; Slice 3 and TASK-057 replay-first/late-generation slice implemented in isolation; TASK-057 remains under verification and does not activate TASK-026 |
| [DP-021: Private Exact-Scope Managed Start Invoker](DP-021-private-exact-scope-managed-start-invoker.md) | Draft; partial, implemented in isolation by TASK-043; TASK-057 implements the command-boundary replay-first/late-generation prerequisite under verification; callback/terminal/orchestrator integration remains absent |
