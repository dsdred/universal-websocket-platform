...
| [DP-016: Runtime Activation, Replacement, and Rollback](DP-016-runtime-activation-replacement-rollback.md) | Approved; planned; TASK-026 is Blocked by the Not Activated DP-015 durable Satisfied-outcome prerequisite; no current TASK-026 implementation exists |
...
| [DP-019: Runtime Activation Orchestration Prerequisites](DP-019-runtime-activation-orchestration-prerequisites.md) | Approved; planned overall; accepted/published TASK-062 satisfies the separate DP-015 parent-terminalization prerequisite; TASK-063 reported `READY — UNBLOCK`; TASK-026 is now Blocked by a newly proven DP-015 durable Satisfied-outcome prerequisite |
| [DP-020: Runtime Orchestration Binding Sequence Readiness](DP-020-runtime-orchestration-binding-sequence-readiness.md) | Draft; planned overall; TASK-061 historical readiness is preserved; TASK-062 is accepted/published and TASK-063 restored 7/10/2/0/0/0 readiness; TASK-026 is now Blocked by a newly proven DP-015 durable Satisfied-outcome prerequisite |
| [DP-021: Private Exact-Scope Managed Start Invoker](DP-021-private-exact-scope-managed-start-invoker.md) | Draft; partial, implemented in isolation by TASK-043; invoker boundary is unchanged; accepted/published TASK-062 repair is outside DP-021; TASK-026 is now Blocked and its next prerequisite is Not Activated |
