...
| [DP-015: Runtime Management Command Idempotency](DP-015-runtime-management-command-idempotency.md) | Approved; Partial implementation: accepted isolated seams remain; fresh TASK-026 evidence identifies one parent-terminalization prerequisite for terminal `StopOld` with intentionally absent `StartTarget`; repair Not Activated |
| [DP-016: Runtime Activation, Replacement, and Rollback](DP-016-runtime-activation-replacement-rollback.md) | Approved; planned; TASK-061 historical accepted `READY — UNBLOCK` remains 7/10/2/0/0/0; TASK-026 Blocked by the newly proven DP-015 parent-terminalization prerequisite |
...
| [DP-019: Runtime Activation Orchestration Prerequisites](DP-019-runtime-activation-orchestration-prerequisites.md) | Approved; planned overall; accepted isolated seams remain; TASK-026 Blocked by one separate DP-015 parent-terminalization prerequisite, Not Activated |
| [DP-020: Runtime Orchestration Binding Sequence Readiness](DP-020-runtime-orchestration-binding-sequence-readiness.md) | Draft; planned overall; accepted isolated slices remain; TASK-061 historical readiness is preserved, while TASK-026 is Blocked by the newly proven DP-015 parent-terminalization prerequisite |
| [DP-021: Private Exact-Scope Managed Start Invoker](DP-021-private-exact-scope-managed-start-invoker.md) | Draft; partial, implemented in isolation by TASK-043; invoker boundary is unchanged; TASK-026 is Blocked by a separate DP-015 parent-terminalization prerequisite outside DP-021 |
