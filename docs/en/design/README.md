...
| [DP-011: Runtime Launch Pipeline Integration](DP-011-runtime-launch-pipeline-integration.md) | Draft; base implemented in isolation, DP-019 continuation and binding gate planned |
...
| [DP-015: Runtime Management Command Idempotency](DP-015-runtime-management-command-idempotency.md) | Approved; primitive boundary and DP-019 parent/phase sequential core implemented in isolation, Continue/pending-Stop planned |
| [DP-016: Runtime Activation, Replacement, and Rollback](DP-016-runtime-activation-replacement-rollback.md) | Approved; planned and architecture-blocked by unimplemented DP-019 prerequisites |
...
| [DP-019: Runtime Activation Orchestration Prerequisites](DP-019-runtime-activation-orchestration-prerequisites.md) | Approved; planned overall, parent/phase sequential core implemented in isolation |
