...
| [DP-015: Runtime Management Command Idempotency](DP-015-runtime-management-command-idempotency.md) | Approved; Partial implementation: TASK-062 implements the bounded parent-terminalization repair in isolation and is Completed, independently accepted, and published through PR #65 |
| [DP-016: Runtime Activation, Replacement, and Rollback](DP-016-runtime-activation-replacement-rollback.md) | Approved; planned; TASK-063 current `READY — UNBLOCK` is 7/10/2/0/0/0 after TASK-062 restores row 15; TASK-026 is Ready to Reactivate but Not Activated |
...
| [DP-019: Runtime Activation Orchestration Prerequisites](DP-019-runtime-activation-orchestration-prerequisites.md) | Approved; planned overall; accepted/published TASK-062 satisfies the separate DP-015 parent-terminalization prerequisite; TASK-063 reports current `READY — UNBLOCK`; TASK-026 remains Not Activated |
| [DP-020: Runtime Orchestration Binding Sequence Readiness](DP-020-runtime-orchestration-binding-sequence-readiness.md) | Draft; planned overall; TASK-061 historical readiness is preserved; TASK-062 is accepted/published and TASK-063 restores current 7/10/2/0/0/0 readiness; TASK-026 remains Not Activated |
| [DP-021: Private Exact-Scope Managed Start Invoker](DP-021-private-exact-scope-managed-start-invoker.md) | Draft; partial, implemented in isolation by TASK-043; invoker boundary is unchanged; accepted/published TASK-062 repair is outside DP-021, and TASK-063 does not activate TASK-026 |
