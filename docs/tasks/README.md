...
- [TASK-026 — Runtime Activation, Replacement, and Rollback Implementation](TASK-026-RUNTIME-ACTIVATION-REPLACEMENT-ROLLBACK.md) — In Progress, Design-only readiness reassessment accepted as `READY — UNBLOCK TASK-026`; current matrix 7 Direct / 10 Compositional / 2 Missing core / 0 Missing prerequisite / 0 Missing external / 0 Deferred; DP-016 remains Approved/Planned and implementation transition is Not Activated; no implementation/Acceptance/Completion/commit/publication
