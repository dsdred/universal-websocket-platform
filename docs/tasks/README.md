...
- [TASK-026 — Runtime Activation, Replacement, and Rollback Implementation](TASK-026-RUNTIME-ACTIVATION-REPLACEMENT-ROLLBACK.md) — Blocked by unimplemented DP-015 tracked-Start managed-parent plus preclaimed StopOld admission prerequisite; corrected matrix 7 Direct / 9 Compositional / 2 Missing core / 1 Missing prerequisite / 0 Deferred; design refinement completed as TASK-046, implementation next candidate Not Activated with no Task ID; no implementation/Acceptance/commit/publication
