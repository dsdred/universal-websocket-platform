...
- [TASK-026 — Runtime Activation, Replacement, and Rollback Implementation](TASK-026-RUNTIME-ACTIVATION-REPLACEMENT-ROLLBACK.md) — Ready to Reactivate, Not Activated after TASK-044 architecture verdict; no implementation/Acceptance/commit/publication
