...
| [DP-015: Идемпотентность management commands Runtime](DP-015-runtime-management-command-idempotency.md) | Approved; Partial implementation: primitive/parent managed gates, parent/phase core, Continue/pending-Stop, continuation Среза 3, tracked-Start managed-parent admission TASK-047 и replay-first/late-generation admission TASK-057 реализованы и prospectively accepted изолированно |
| [DP-016: Activation, replacement и rollback Runtime](DP-016-runtime-activation-replacement-rollback.md) | Approved; Planned; TASK-061 `READY — UNBLOCK` с 7/10/2/0/0/0; TASK-026 Ready to Reactivate, но Not Activated |
...
| [DP-019: Предпосылки оркестрации активации Runtime](DP-019-runtime-activation-orchestration-prerequisites.md) | Approved; planned overall; managed command/Flow/continuation и seams binding attempt/generation вместе с replay-first/late-generation admission TASK-057 реализованы изолированно; TASK-061 `READY — UNBLOCK`; TASK-026 Not Activated |
| [DP-020: Готовность последовательности связывания оркестрации Runtime](DP-020-runtime-orchestration-binding-sequence-readiness.md) | Draft; planned overall; Срез 3 и replay-first/late-generation slice TASK-057 реализованы изолированно; TASK-060 prospectively accepts четыре exact claims; TASK-026 Not Activated |
| [DP-021: Private Exact-Scope Managed Start Invoker](DP-021-private-exact-scope-managed-start-invoker.md) | Draft; partial, реализован изолированно TASK-043; command-boundary prerequisite TASK-057 prospectively accepted через TASK-060; callback/terminal/orchestrator integration по-прежнему отсутствует |
