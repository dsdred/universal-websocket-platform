...
| [DP-016: Activation, replacement и rollback Runtime](DP-016-runtime-activation-replacement-rollback.md) | Approved; Planned; current `READY — UNBLOCK` TASK-063 — 7/10/2/0/0/0 после восстановления row 15 TASK-062; TASK-026 Ready to Reactivate, но Not Activated |
...
| [DP-019: Предпосылки оркестрации активации Runtime](DP-019-runtime-activation-orchestration-prerequisites.md) | Approved; planned overall; accepted/published TASK-062 удовлетворяет отдельный DP-015 parent-terminalization prerequisite; TASK-063 возвращает current `READY — UNBLOCK`; TASK-026 остаётся Not Activated |
| [DP-020: Готовность последовательности связывания оркестрации Runtime](DP-020-runtime-orchestration-binding-sequence-readiness.md) | Draft; planned overall; historical readiness TASK-061 сохраняется; TASK-062 принята/опубликована, TASK-063 восстанавливает current readiness 7/10/2/0/0/0; TASK-026 остаётся Not Activated |
| [DP-021: Private Exact-Scope Managed Start Invoker](DP-021-private-exact-scope-managed-start-invoker.md) | Draft; partial, реализован изолированно TASK-043; invoker boundary неизменна; accepted/published repair TASK-062 находится вне DP-021, а TASK-063 не активирует TASK-026 |
