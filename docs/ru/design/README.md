...
| [DP-022: Граница containment исполнения Runtime и evidence](DP-022-runtime-execution-containment-and-evidence.md) | Draft; запланирован; определяет containment/evidence prerequisite, требуемый DP-017 §11; containment capability, ledger и evidence adapter отсутствуют, реализация DP-017 не активирована |
