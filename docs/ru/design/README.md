...
| [DP-015: Идемпотентность management commands Runtime](DP-015-runtime-management-command-idempotency.md) | Approved; Partial implementation: primitive/parent managed gates, parent/phase core, Continue/pending-Stop, continuation Среза 3, tracked-Start managed-parent admission TASK-047 и replay-first/late-generation admission TASK-057 реализованы изолированно; TASK-057 projected In Progress под post-sync verification |
| [DP-016: Activation, replacement и rollback Runtime](DP-016-runtime-activation-replacement-rollback.md) | Approved; запланирован; TASK-026 заблокирована; design refinement TASK-049 завершена и принята Coordinator; isolated prerequisite TASK-057 реализован под verification до отдельной post-acceptance readiness reassessment |
...
| [DP-019: Предпосылки оркестрации активации Runtime](DP-019-runtime-activation-orchestration-prerequisites.md) | Approved; planned overall; managed command/Flow/continuation и seams binding attempt/generation вместе с replay-first/late-generation admission TASK-057 реализованы изолированно; TASK-026 остаётся Blocked |
| [DP-020: Готовность последовательности связывания оркестрации Runtime](DP-020-runtime-orchestration-binding-sequence-readiness.md) | Draft; planned overall; Срез 3 и replay-first/late-generation slice TASK-057 реализованы изолированно; TASK-057 остаётся под verification и не активирует TASK-026 |
| [DP-021: Private Exact-Scope Managed Start Invoker](DP-021-private-exact-scope-managed-start-invoker.md) | Draft; partial, реализован изолированно TASK-043; TASK-057 реализует command-boundary replay-first/late-generation prerequisite под verification; callback/terminal/orchestrator integration по-прежнему отсутствует |
