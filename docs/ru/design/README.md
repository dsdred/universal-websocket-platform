...
| [DP-015: Идемпотентность management commands Runtime](DP-015-runtime-management-command-idempotency.md) | Approved; primitive/parent managed gates, parent/phase core, Continue/pending-Stop и continuation Среза 3 реализованы изолированно; tracked-Start managed-parent плюс preclaimed StopOld admission и complete extension запланированы |
| [DP-016: Activation, replacement и rollback Runtime](DP-016-runtime-activation-replacement-rollback.md) | Approved; запланирован; TASK-026 заблокирована одной missing DP-015 command-admission prerequisite после superseding recheck |
...
| [DP-021: Private Exact-Scope Managed Start Invoker](DP-021-private-exact-scope-managed-start-invoker.md) | Draft; partial, реализован изолированно TASK-043; callback/terminal/orchestrator integration отсутствует |
