...
| [DP-022: Граница containment исполнения Runtime и evidence](DP-022-runtime-execution-containment-and-evidence.md) | Approved; запланирован; TASK-069 реализует isolated Windows-only bootstrap substrate, но evidence adapter/composition отсутствуют и DP-017 остаётся неактивированной |
| [DP-023: Bootstrap process-containment Runtime](DP-023-runtime-process-containment-bootstrap.md) | Approved; реализован изолированно как Windows-only первый slice в worktree TASK-069; latest verification/review/Acceptance checkpoint определяется newest valid matching envelope TASK-069; production wiring и downstream activation отсутствуют |
