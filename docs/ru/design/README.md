...
| [DP-015: Идемпотентность management commands Runtime](DP-015-runtime-management-command-idempotency.md) | Approved; Partial implementation: TASK-062 parent-terminalization repair принята/опубликована; TASK-064 durable primitive Satisfied-outcome repair принята Coordinator изолированно, commit/publication не выполнялись |
| [DP-016: Activation, replacement и rollback Runtime](DP-016-runtime-activation-replacement-rollback.md) | Approved; Planned; TASK-026 остаётся Blocked после изолированно принятого Coordinator prerequisite TASK-064; текущая implementation TASK-026 отсутствует |
...
| [DP-019: Предпосылки оркестрации активации Runtime](DP-019-runtime-activation-orchestration-prerequisites.md) | Approved; planned overall; accepted/published TASK-062 удовлетворяет parent-terminalization prerequisite; durable Satisfied-outcome prerequisite TASK-064 принята Coordinator изолированно; TASK-026 остаётся Blocked |
| [DP-020: Готовность последовательности связывания оркестрации Runtime](DP-020-runtime-orchestration-binding-sequence-readiness.md) | Draft; planned overall; historical readiness TASK-061 сохраняется; TASK-062 принята/опубликована, TASK-063 восстановила readiness 7/10/2/0/0/0; позднейший DP-015 repair TASK-064 принят Coordinator изолированно, TASK-026 остаётся Blocked |
| [DP-021: Private Exact-Scope Managed Start Invoker](DP-021-private-exact-scope-managed-start-invoker.md) | Draft; partial, реализован изолированно TASK-043; invoker boundary неизменна; accepted/published TASK-062 и active TASK-064 repairs находятся вне DP-021; TASK-026 остаётся Blocked |
