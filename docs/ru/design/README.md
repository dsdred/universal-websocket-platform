...
| [DP-015: Идемпотентность management commands Runtime](DP-015-runtime-management-command-idempotency.md) | Approved; primitive/parent managed gates, parent/phase core, Continue/pending-Stop, continuation Среза 3 и admission tracked-Start managed-parent TASK-047 реализованы изолированно; design refinement replay-first/late-generation TASK-049 завершена и принята Coordinator; isolated implementation Not Activated |
| [DP-016: Activation, replacement и rollback Runtime](DP-016-runtime-activation-replacement-rollback.md) | Approved; запланирован; TASK-026 заблокирована; design refinement TASK-049 завершена и принята Coordinator; isolated implementation Not Activated без Task ID |
...
| [DP-019: Предпосылки оркестрации активации Runtime](DP-019-runtime-activation-orchestration-prerequisites.md) | Approved; planned overall; managed command/Flow/continuation и seams binding attempt/generation реализованы изолированно; design refinement TASK-049 завершена и принята Coordinator; isolated implementation Not Activated |
| [DP-020: Готовность последовательности связывания оркестрации Runtime](DP-020-runtime-orchestration-binding-sequence-readiness.md) | Draft; planned overall; Срез 3 реализован и независимо принят изолированно; design refinement replay-first/late-generation TASK-049 завершена и принята Coordinator; isolated implementation Not Activated |
| [DP-021: Private Exact-Scope Managed Start Invoker](DP-021-private-exact-scope-managed-start-invoker.md) | Draft; partial, реализован изолированно TASK-043; callback/terminal/orchestrator integration отсутствует; design refinement TASK-049 завершена и принята Coordinator; isolated implementation Not Activated |
