...
| [DP-015: Идемпотентность management commands Runtime](DP-015-runtime-management-command-idempotency.md) | Approved; Partial implementation: принятые isolated seams сохраняются; fresh TASK-026 evidence определяет parent-terminalization prerequisite для terminal `StopOld` при намеренно отсутствующем `StartTarget`; repair Not Activated |
| [DP-016: Activation, replacement и rollback Runtime](DP-016-runtime-activation-replacement-rollback.md) | Approved; Planned; historical accepted `READY — UNBLOCK` TASK-061 остаётся 7/10/2/0/0/0; TASK-026 Blocked by newly proven DP-015 parent-terminalization prerequisite |
...
| [DP-019: Предпосылки оркестрации активации Runtime](DP-019-runtime-activation-orchestration-prerequisites.md) | Approved; planned overall; принятые isolated seams сохраняются; TASK-026 Blocked by one separate DP-015 parent-terminalization prerequisite, Not Activated |
| [DP-020: Готовность последовательности связывания оркестрации Runtime](DP-020-runtime-orchestration-binding-sequence-readiness.md) | Draft; planned overall; принятые isolated slices сохраняются; historical readiness TASK-061 неизменна, а TASK-026 Blocked by newly proven DP-015 parent-terminalization prerequisite |
| [DP-021: Private Exact-Scope Managed Start Invoker](DP-021-private-exact-scope-managed-start-invoker.md) | Draft; partial, реализован изолированно TASK-043; invoker boundary неизменна; TASK-026 Blocked by separate DP-015 parent-terminalization prerequisite вне DP-021 |
