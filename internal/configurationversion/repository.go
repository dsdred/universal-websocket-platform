...
// ErrVersionNotEditable indicates that a Version cannot be edited in its current state.
var ErrVersionNotEditable = errors.New("configuration version is not editable")
