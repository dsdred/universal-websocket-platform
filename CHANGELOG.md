...
- Focused Draft DP-008 contract and isolated Snapshot Builder implementation
  over neutral `DetachedLoadResult`, with exact `uwp.configuration` v1
  support, complete ARCH-005 provenance, private detached readers, canonical
  normalization, and exhaustive blocking Diagnostics; the production launch
