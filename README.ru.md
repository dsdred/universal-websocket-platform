...
Проект находится на этапе **M0 Bootstrap**. Репозиторий содержит инженерную основу, основу спецификаций и минимальный Control Service на Go с endpoint проверки состояния.
